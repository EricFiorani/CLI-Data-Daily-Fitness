class DailyFitness::Nutrition
  ...
  def self.sub_article_1(doc)
    ...
    article = self.new
    article.title = doc.search("#DPG_Nutrition_Sub_1 .title").text.strip
    article.description = doc.search("#DPG_Nutrition_Sub_1 .description").text.strip
    article.url = doc.search("#DPG_Nutrition_Sub_1 a.thumb-container").map {|link| link['href'] }
  ...
  def self.sub_article_2(doc)
    ...
    article = self.new
    article.title = doc.search("#DPG_Nutrition_Sub_2 .title").text.strip
    article.description = doc.search("#DPG_Nutrition_Sub_2 .description").text.strip
    article.url = doc.search("#DPG_Nutrition_Sub_2 a.thumb-container").map {|link| link['href'] }
  ...
  def self.sub_article_3(doc)
    ...
    article = self.new
    article.title = doc.search("#DPG_Nutrition_Sub_3 .title").text.strip
    article.description = doc.search("#DPG_Nutrition_Sub_3 .description").text.strip
    article.url = doc.search("#DPG_Nutrition_Sub_3 a.thumb-container").map {|link| link['href'] }
